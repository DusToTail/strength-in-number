...
//     version 1.6.3
//     from Assets/Scripts/Input/Input_InputAction.inputactions
//
...
public partial class @Input_InputAction: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @Input_InputAction()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""Input_InputAction"",
    ""maps"": [
        {
            ""name"": ""GridBuilder"",
    ...
    {
        private @Input_InputAction m_Wrapper;
        public GridBuilderActions(@Input_InputAction wrapper) { m_Wrapper = wrapper; }
